...
class NotificationHandlerTest(TestCase):
    ...
    def test_notification_handler_action_checks(self):
        ...
        insert_handler = NotificationHandler(1, {'action': 'INSERT'}, 'test', 0.0)
        update_handler = NotificationHandler(2, {'action': 'UPDATE'}, 'test', 0.0)
        delete_handler = NotificationHandler(3, {'action': 'DELETE'}, 'test', 0.0)
...
class BaseConsumerTest(TestCase):
    ...
    def test_mark_processed(self):
        ...
        notification = NotificationLog.objects.create(
            channel='test_channel', payload={'test': 'data'}
        )
    ...
    def test_create_notification_handler(self):
        ...
        notification = NotificationLog.objects.create(
            channel='test_channel', payload={'action': 'INSERT', 'table': 'users'}
        )
    ...
    def test_fetch_notification_data_exists(self):
        ...
        notification = NotificationLog.objects.create(
            channel='test', payload={'test': 'data'}
        )
